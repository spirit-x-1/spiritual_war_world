...
SECRET_KEY = 'django-insecure-4uu(kmx5aoz!i_seq*^8!u524s+gdes^(0nstgt=9)%qm(_xvw'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['spiritual-war-django-backend-59901685e3ac.herokuapp.com', 'www.yourdomain.com', '127.0.0.1', 'localhost']
...
STATIC_ROOT = os.path.join(BASE_DIR, 'django_backend', 'staticfiles')
